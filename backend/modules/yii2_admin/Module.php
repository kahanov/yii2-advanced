...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@app/modules/yii2_admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['rbac-admin'])) {
            Yii::$app->i18n->translations['rbac-admin'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath' => '@app/modules/yii2_admin/messages',
            ];
        }
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('backend\modules\yii2_admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
