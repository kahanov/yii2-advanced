...
namespace frontend\components\yii2_device_detect;

use Yii;
use frontend\components\yii2_device_detect\mobiledetect\mobiledetectlib\namespaced\Detection\MobileDetect;
