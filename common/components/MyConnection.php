 ...
 * @property MyConnection $master The currently active master connection. `null` is returned if there is no
 ...
 * is read-only.
 * @property MyConnection $slave The currently active slave connection. `null` is returned if there is no slave
 ...
 * @since 2.0
 */
class MyConnection extends \yii\db\Connection //extends Component
{
    /**
    ...
    private $_driverName;
    /**
     * @var MyConnection the currently active master connection
     */
    private $_master = false;
    /**
     * @var MyConnection the currently active slave connection
     */
     ...
     * @return MyConnection the currently active slave connection. `null` is returned if there is no slave available and
     ...
     * @return MyConnection the currently active master connection. `null` is returned if there is no master available.
     * @since 2.0.11
     */
     ...
     * @return MyConnection the opened DB connection, or `null` if no server is available
