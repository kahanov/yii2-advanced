...
<p style="-webkit-font-smoothing:subpixel-antialiased;margin:10px 0;color:#121212;font-family:helvetica,arial;font-size:15px;line-height:22px;text-align:left">
	...
	<a href="<?= $homeUrl ?>" target="_blank" style="color:#39f!important;text-decoration:underline" rel=" noopener noreferrer"><span style="color:#39f"><?= $homeUrl ?></span></a>.
...
<div style="-webkit-font-smoothing:subpixel-antialiased;margin:30px 0;color:#000;font-family:helvetica,arial;font-size:13px;line-height:18px;text-align:left">
	<a href="<?= $resetLink ?>" target="_blank" style="background-color:#2b87db;border:#2b87db 11px solid;border-radius:25px;color:#fff!important;display:inline-block;font-family:helvetica;font-size:14px;font-weight:700;padding:0 15px;text-decoration:none" rel=" noopener noreferrer"><span style="color:#fff">Восстановить пароль</span></a>
</div>
