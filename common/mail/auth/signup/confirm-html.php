...
<div style="-webkit-font-smoothing:subpixel-antialiased;margin:30px 0;color:#000;font-family:helvetica,arial;font-size:13px;line-height:18px;text-align:left">
	<a href="<?= $confirmLink ?>" target="_blank" style="background-color:#2b87db;border:#2b87db 11px solid;border-radius:25px;color:#fff!important;display:inline-block;font-family:helvetica;font-size:14px;font-weight:700;padding:0 15px;text-decoration:none" rel=" noopener noreferrer"><span style="color:#fff">Подтвердить E-mail</span></a>
</div>
